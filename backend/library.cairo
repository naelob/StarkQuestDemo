# Modified version of OpenZeppelin Contracts for Cairo v0.1.0 
# https://github.com/OpenZeppelin/cairo-contracts/tree/main/src/openzeppelin/token/erc721
...
@event
func Verified(from_: felt, tokenId: Uint256):
end
...
namespace SoleBoundToken:
    ...
    func tokenURI{
        ...
        with_attr error_message("SoleBoundTokenMoment: URI query for nonexistent token"):
            assert exists = TRUE
        end
    ...
    func burn{
        ...
        alloc_locals
        with_attr error_message("SoleBoundTokenMoment: token_id is not a valid Uint256"):
        ...
        # Emit event of the burn to the 0 address
    ...
    func only_token_owner{
        ...
        with_attr error_message("SoleBoundTokenMoment: caller is not the token owner"):
            assert caller = owner
        end
    ...
    func _mint{
        ...
        with_attr error_message("SoleBoundTokenMoment: cannot mint with blank content"):
